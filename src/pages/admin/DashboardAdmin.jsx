    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-2xs space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          ...
          <Link to="/admin/bookings" className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center space-x-1">
          ...
          <div className="space-y-3">
            {pendingBookings.map(b => (
              <div key={b.id} className="p-3.5 rounded-xl border border-slate-200 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                ...
                <Link to="/admin/bookings" className="px-3 py-1.5 bg-indigo-600 text-white font-bold text-xs rounded-lg self-start sm:self-auto">
                  Proses Pengajuan
                </Link>
              </div>
            ))}
